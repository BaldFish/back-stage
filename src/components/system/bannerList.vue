    ...
    <el-row>
      ...
      <el-col :span="24">
        ...
        <el-table :data="tableData" style="width: 100%" @selection-change="handleSelectionChange" @filter-change="handleFilterChange">
          ...
          <el-table-column prop="broadcast_num" label="编号" width="150">
          </el-table-column>
          ...
          <el-table-column prop="bc_status" label="状态" width="150">
          </el-table-column>
          <el-table-column prop="link_url" label="链接地址" width="200">
          </el-table-column>
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    mounted() {
      ...
      axios({
        method: "GET",
        url: `${baseURL}/v1/resource/search?type=show_type`
      })
        .then(res => {
    ...
    methods: {
     ...
     /*   this.tableData = [];
      ...
      getClassifyList() {
        ...
        axios({
          method: "GET",
          url: `${baseURL}/v1/broadcast?page=${this.page}&limit=${this.limit}`
        }).then(res => {
      ...
      handleDelete(index, row) {
        this.$confirm('确认删除此条数据, 是否继续?', '提示', {
          ...
          axios({
            method: "DELETE",
            url: `${baseURL}/v1/broadcast/${row._id}`,
            headers: {
      ...
      handleDeletes() {
        this.$confirm('确认删除此条数据, 是否继续?', '提示', {
          ...
          axios({
            method: "POST",
            url: `${baseURL}/v1/broadcast/delete-batch`,
            data: multipleData,
            headers: {
              "X-Access-Token": token,
